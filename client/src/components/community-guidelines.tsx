    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <Card className="border-primary/20">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl">Writers Guild Community Guidelines</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            If you believe your content was incorrectly removed or you were unfairly penalized, 
            you can appeal the decision by contacting our moderation team. All appeals are 
            reviewed fairly and thoroughly.
          </p>
        </CardContent>
      </Card>
